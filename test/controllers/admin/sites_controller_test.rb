...
class Admin::SitesControllerTest < ActionController::TestCase
  ...
  test "should create admin_site" do
    assert_difference('Admin::Site.count') do
      post :create, admin_site: { avatar: @admin_site.avatar, name: @admin_site.name, url: @admin_site.url, weight: @admin_site.weight }
    end
  ...
  test "should update admin_site" do
    patch :update, id: @admin_site, admin_site: { avatar: @admin_site.avatar, name: @admin_site.name, url: @admin_site.url, weight: @admin_site.weight }
    assert_redirected_to admin_site_path(assigns(:admin_site))
  end
