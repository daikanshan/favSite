...
class Admin::UsersControllerTest < ActionController::TestCase
  ...
  test "should create admin_user" do
    assert_difference('Admin::User.count') do
      post :create, admin_user: { level: @admin_user.level, password_digest: @admin_user.password_digest, username: @admin_user.username }
    end
  ...
  test "should update admin_user" do
    patch :update, id: @admin_user, admin_user: { level: @admin_user.level, password_digest: @admin_user.password_digest, username: @admin_user.username }
    assert_redirected_to admin_user_path(assigns(:admin_user))
  end
